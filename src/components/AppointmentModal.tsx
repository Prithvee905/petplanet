        ...
        if (web3FormsKey) {
          const res = await fetch('https://api.web3forms.com/submit', {
            ...
            body: JSON.stringify({
              ...
              "🏢 Clinic": "Pet Planet Dog Clinic & Animal Diagnostics",
              "📍 Location": "Kothapet, Hyderabad",
              "--------------------------------": "",
              "👤 Owner Name": data.name,
              "📞 Phone Number": data.phone,
              "🐶 Pet Name": data.pet_name || 'Not provided',
              "🐾 Pet Type": data.pet_type,
              "📅 Preferred Date": data.preferred_date,
              "⏰ Preferred Time": data.preferred_time || 'Anytime',
              "📝 Customer Notes": data.message || 'None',
              "---------------------------------": "",
              "⚠️ Action Required": "Please call the customer to confirm the appointment.",
            })
          });
