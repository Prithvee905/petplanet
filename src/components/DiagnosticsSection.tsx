      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-4 sm:gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-1 grid grid-cols-1 gap-4">
            ...
            >
              <img src="/diagnostics-2.jpg" alt="Diagnostics Services" className="max-h-[420px] sm:max-h-[650px] lg:max-h-[950px] w-auto object-contain drop-shadow-2xl" />
            </motion.div>
          </div>
          ...
          >
            <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-3 md:mb-6 leading-tight">Precision Clinical <span className="text-orange">Diagnostics.</span></h2>
            <p className="text-sm sm:text-base lg:text-xl font-body text-gray-300 mb-4 md:mb-8 leading-relaxed">
            ...
            <ul className="space-y-2.5 md:space-y-4">
              {[
                ...
                <li key={i} className="flex items-center gap-2 md:gap-3">
                  ...
                  <span className="text-sm sm:text-base lg:text-lg font-body text-gray-200 font-medium">{item}</span>
                </li>
              ))}
            </ul>
          </motion.div>
